...
CFLAGS = -std=c99 -Wall -Wextra -Wno-missing-braces -Wunused-result -D_DEFAULT_SOURCE
...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -I$(RAYLIB_PATH)/src/extras -IC:/emsdk/upstream/emscripten/cache/sysroot/include -Iinclude
